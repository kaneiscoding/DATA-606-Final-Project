...
ctrl_balanced <- trainControl(method = "cv", number = 10, summaryFunction = cfm, sampling="down", classProbs = TRUE)
```
...
```{r}
lrb_0_0 <- c(25520,25855,25876,25839,25672,25691,25782,25639, 25763,25748)
lrb_0_1 <- c(4202,4309,4197,4231,4215,4156,4281,4196, 4267,4195)
lrb_1_0 <- c(13667,13332,13311,13348,13515,13497,13405,13548, 13424,13439)
lrb_1_1 <- c(9606,9499,9612,9578,9594,9652,9528,9613, 9542,9614)
...
5.  S. (n.d.). *Get-several-audio-features*. Spotify. [https://developer.spotify.com/documentation/web-api/reference/#/operations/get-several-audio-features](https://developer.spotify.com/documentation/web-api/reference/)
