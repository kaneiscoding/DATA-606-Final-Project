...
```
The results of the 10 k-fold cross validation echoed the results of the training set. The mean misclassification was 0.2474. This is a higher misclassification than the the logisitic regression model, and therefore the classification tree is not recommended. 
